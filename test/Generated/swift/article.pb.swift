...
public struct Example_V1_ListArticlesRequest: Sendable {
  ...
  public var pagination: Example_V1_PaginationRequest {
    get {return _pagination ?? Example_V1_PaginationRequest()}
  ...
  fileprivate var _pagination: Example_V1_PaginationRequest? = nil
}
...
public struct Example_V1_ListArticlesResponse: Sendable {
  ...
  public var pagination: Example_V1_PaginationResponse {
    get {return _pagination ?? Example_V1_PaginationResponse()}
    set {_pagination = newValue}
  }
  /// Returns true if `pagination` has been explicitly set.
  public var hasPagination: Bool {return self._pagination != nil}
  ...
  fileprivate var _pagination: Example_V1_PaginationResponse? = nil
}
...
extension Example_V1_ListArticlesResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}articles\0\u{1}pagination\0")
